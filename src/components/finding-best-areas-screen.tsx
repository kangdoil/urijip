    ...
    <main className="flex flex-1 flex-col items-center bg-neutral-50 px-4 pt-[138px]">
      ...
      <div className="mt-12 flex flex-col items-center gap-3">
        ...
        <div className="relative flex flex-col items-center pb-4">
          {/* 다음 순서로 올라올 메시지가 살짝 미리 보이는 "카드 스택" 연출 —
              뒤 카드는 앞 카드보다 작고 흐리게, 아래로 살짝 삐져나오게 배치한다. */}
          <div
            aria-hidden
            className="absolute top-[40px] left-1/2 w-[78%] -translate-x-1/2 rounded-2xl bg-white px-5 py-4 opacity-30 shadow-[0_8px_8px_rgba(0,0,0,0.04)]"
          >
            <p className="truncate text-center text-xs font-bold text-neutral-900">
          ...
          <p
            ...
            role="status"
            aria-live="polite"
            className="animate-in fade-in slide-in-from-bottom-2 relative z-10 rounded-xl bg-white px-8 py-6 text-center text-[15px] font-bold text-neutral-900 shadow-[0_10px_10px_rgba(0,0,0,0.04)] duration-500"
          >
